...
export const metadata = {
  ...
  description:
    "Server-side filtered product browsing with category, brand, rating, price, and stock controls.",
};
          ...
          {pagination.totalCount ? (
            ...
            <div className="rounded-4xl border border-dashed border-slate-300 bg-white p-10 text-center shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-600">
                Try widening the price range, clearing tags, or switching
                categories.
              </p>
            </div>
          )}
              ...
              <Link
                href={
                  pagination.hasPreviousPage
                    ? `?${buildQueryString(resolvedSearchParams, { cursor: pagination.previousCursor ?? "", page: filters.page, sort: filters.sort })}`
                    : "#"
                }
              ...
              <Link
                href={
                  pagination.hasNextPage
                    ? `?${buildQueryString(resolvedSearchParams, { cursor: pagination.nextCursor ?? "", page: filters.page, sort: filters.sort })}`
                    : "#"
                }
